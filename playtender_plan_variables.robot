...
${plan_form_procurement_method_type_input_locator} =                id=planreportingform-procurement_method_type
${plan_form_budget_id_input_locator} =                              id=planreportingform-budget_id
${plan_form_project_id_input_locator} =                             id=planreportingform-project_id
${plan_form_project_name_input_locator} =                           id=planreportingform-project_name
${plan_form_title_input_locator} =                                  id=planreportingform-title
${plan_form_year_input_locator} =                                   id=planreportingform-year
${plan_form_tender_start_date_input_locator} =                      id=planreportingform-tender_start_date
${plan_form_value_amount_input_locator} =                           id=planreportingform-value_amount-disp
${plan_form_value_currency_input_locator} =                         id=planreportingform-value_currency
${plan_form_classification_edit_btn_locator} =                      jquery=.field-planreportingform-classification_id .js-classification-input-wrapper [data-toggle="classification"]
${plan_form_additional_classification_edit_btn_locator} =           jquery=.field-planreportingform-additional_classification_ids .js-additional-classification-input-wrapper [data-toggle="additional-classification"]
${plan_form_kekv_classification_edit_btn_locator} =                 jquery=.field-planreportingform-additional_classification_ids_kekv .js-additional-classification-input-wrapper [data-toggle="additional_classification_ids_kekv"]
